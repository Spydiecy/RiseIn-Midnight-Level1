...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      increment: (...args_1) => {
        ...
        if (!(typeof(increment_by_0) === 'bigint' && increment_by_0 >= 0n && increment_by_0 <= 65535n)) {
          __compactRuntime.typeError('increment',
  ...
  _increment_0(context, partialProofData, increment_by_0) {
    __compactRuntime.assert(increment_by_0 > 0n, 'increment_by must be positive');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
  ...
  _reset_0(context, partialProofData) {
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 65535n) {
                      throw new __compactRuntime.CompactError('counter.compact line 45 char 21: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 65535');
                    }
                    return t1;
                  })(current_0);
    __compactRuntime.queryLedgerState(context,
